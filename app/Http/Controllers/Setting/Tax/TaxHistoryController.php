...
class TaxHistoryController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'setting', menuParam: 'tax_history', subModule: 'setting_tax_tax_history', menuRoute: 'tax-history', menuUrl: 'setting/tax/tax-history');

        $this->index_file = 'setting.tax.tax_history.index';
    ...
    public function index()
    {
        ...
        $formData['action'] = $this->globalVariable->actionGetTax;
