...
class DivisionController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'master_data', menuParam: 'division', subModule: 'master_data_relation_division', menuRoute: 'division', menuUrl: 'master-data/relation/division');

        $this->index_file = 'master_data.relation.division.index';
        $this->form_file = 'master_data.relation.division.form';
    ...
    public function index()
    {
        ...
        $formData['action'] = $this->globalVariable->actionGetDivision;
    ...
    {
        $set_request = SetRequestGlobal('addDivision', $request, formatCode: 'code_division');
    ...
    public function show(string $id)
    {
        ...
        $set_request = SetRequestGlobal(action: $this->globalVariable->actionGetDivision, search: $search_key);
        ...
        $formData['list_nav_button'] = $generate_nav_button;
        $formData['master_data_relation_division'] = $decodedData;
        $formData['selectActive'] = $this->arrayIsActive;
    ...
    {
        $set_request = SetRequestGlobal('updateDivision', $request);
    ...
    {
        $set_request = SetRequestGlobal('softDeleteDivision');
