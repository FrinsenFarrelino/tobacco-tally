...
class PositionController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'master_data', menuParam: 'position', subModule: 'master_data_relation_position', menuRoute: 'position', menuUrl: 'master-data/relation/position');
    ...
    {
        $set_request = SetRequestGlobal('addPosition', $request, formatCode: 'code_position');
    ...
    public function show(string $id)
    {
        ...
        $set_request = SetRequestGlobal(action: $this->globalVariable->actionGetPosition, search: $search_key);
        ...
        $formData['list_nav_button'] = $generate_nav_button;
        $formData['master_data_relation_position'] = $decodedData;
        $formData['selectActive'] = $this->arrayIsActive;
    ...
    {
        $set_request = SetRequestGlobal('updatePosition', $request);
    ...
    {
        $set_request = SetRequestGlobal('softDeletePosition');
