...
class ItemController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'master_data', menuParam: 'item', subModule: 'master_data_product_item', menuRoute: 'item', menuUrl: 'master-data/product/item');
    ...
    public function create()
    {
        ...
        $formData['action_type'] = $this->globalVariable->actionGetType;
        $formData['action_category'] = $this->globalVariable->actionGetCategory;
        $formData['action_unit'] = $this->globalVariable->actionGetUnit;
    ...
    {
        $set_request = SetRequestGlobal('addItem', $request, formatCode: 'code_item');
    ...
    public function show(string $id)
    {
        ...
        $set_request = SetRequestGlobal(action: $this->globalVariable->actionGetItem, search: $search_key);
        ...
        $formData['list_nav_button'] = $generate_nav_button;
        $formData['master_data_product_item'] = $decodedData;
        $formData['selectActive'] = $this->arrayIsActive;
        $formData['action_type'] = $this->globalVariable->actionGetType;
        $formData['action_category'] = $this->globalVariable->actionGetCategory;
        $formData['action_unit'] = $this->globalVariable->actionGetUnit;
    ...
    {
        $set_request = SetRequestGlobal('updateItem', $request);
    ...
    {
        $set_request = SetRequestGlobal('softDeleteItem');
