...
class CategoryController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'master_data', menuParam: 'category', subModule: 'master_data_product_category', menuRoute: 'category', menuUrl: 'master-data/product/category');

        $this->index_file = 'master_data.product.category.index';
        $this->form_file = 'master_data.product.category.form';
    ...
    public function index()
    {
        ...
        $formData['action'] = $this->globalVariable->actionGetCategory;
    ...
    {
        $set_request = SetRequestGlobal('addCategory', $request, formatCode: 'code_category');
    ...
    public function show(string $id)
    {
        ...
        $set_request = SetRequestGlobal(action: $this->globalVariable->actionGetCategory, search: $search_key);
        ...
        $formData['list_nav_button'] = $generate_nav_button;
        $formData['master_data_product_category'] = $decodedData;
        $formData['selectActive'] = $this->arrayIsActive;
    ...
    {
        $set_request = SetRequestGlobal('updateCategory', $request);
    ...
    {
        $set_request = SetRequestGlobal('softDeleteCategory');
