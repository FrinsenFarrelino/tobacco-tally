...
class CategoryController extends Controller
{
    ...
    public function __construct(GlobalVariable $globalVariable)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'master_data', menuParam: 'category', subModule: 'master_data_product_category', menuRoute: 'category', menuUrl: 'master-data/business/category');
