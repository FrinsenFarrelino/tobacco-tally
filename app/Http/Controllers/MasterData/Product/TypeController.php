...
class TypeController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'master_data', menuParam: 'type', subModule: 'master_data_product_type', menuRoute: 'type', menuUrl: 'master-data/product/type');
    ...
    {
        $set_request = SetRequestGlobal('addType', $request, formatCode: 'code_type');
    ...
    public function show(string $id)
    {
        ...
        $set_request = SetRequestGlobal(action: $this->globalVariable->actionGetType, search: $search_key);
        ...
        $formData['list_nav_button'] = $generate_nav_button;
        $formData['master_data_product_type'] = $decodedData;
        $formData['selectActive'] = $this->arrayIsActive;
    ...
    {
        $set_request = SetRequestGlobal('updateType', $request);
    ...
    {
        $set_request = SetRequestGlobal('softDeleteType');
