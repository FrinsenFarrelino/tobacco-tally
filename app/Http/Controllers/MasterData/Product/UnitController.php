...
class UnitController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'master_data', menuParam: 'unit', subModule: 'master_data_product_unit', menuRoute: 'unit', menuUrl: 'master-data/product/unit');

        $this->index_file = 'master_data.product.unit.index';
        $this->form_file = 'master_data.product.unit.form';
    ...
    public function index()
    {
        ...
        $formData['action'] = $this->globalVariable->actionGetUnit;
    ...
    public function show(string $id)
    {
        ...
        $formData['list_nav_button'] = $generate_nav_button;
        $formData['master_data_product_unit'] = $decodedData;
        $formData['selectActive'] = $this->arrayIsActive;
