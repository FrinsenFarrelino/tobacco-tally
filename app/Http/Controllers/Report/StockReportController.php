...
class StockReportController extends GlobalController
{
    ...
    public function __construct(GlobalVariable $globalVariable, GlobalActionController $globalActionController)
    {
        ...
        $this->globalVariable->ModuleGlobal(module: 'report', menuParam: 'stock_report', subModule: 'report_stock_report', menuRoute: 'stock-report', menuUrl: 'report/stock-report');

        $this->index_file = 'report.stock_report.index';
    }
    ...
    public function index()
    {
        ...
        $formData['action'] = $this->globalVariable->actionGetStockReport;
