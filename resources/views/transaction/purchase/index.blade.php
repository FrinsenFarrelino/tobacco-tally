                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('transaction_purchase')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        <th>{{ __('transaction_purchase')['col_code'] }}</th>
                                        <th>{{ __('transaction_purchase')['col_date'] }}</th>
                                        <th>{{ __('transaction_purchase')['col_supplier'] }}</th>
                                        <th>{{ __('transaction_purchase')['col_total'] }}</th>
                                        <th>{{ __('transaction_purchase')['col_is_approve'] }}</th>
                                        <th>{{ __('transaction_purchase')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
