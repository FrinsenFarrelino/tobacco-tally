                    ...
                    <div class="card">
                        ...
                        <script language="javascript" type="text/javascript">
                            ...
                            <?php
                                ...
                                [
                                    "id", "purchase_id", "item_id", "item_code", "item_name", "amount", "unit", "buy_price", "subtotal"
                                ],
                                [
                                    [
                                        'name' => "'id'",
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    {!! renderFieldCombineInput('mb-3 row', 'col-md-4', 'col-md-8', __('transaction_purchase')['col_ppn'], 'col-3 col-lg-2', 'col-3 col-lg-2', 'col-6 col-lg-8', 'ppn', $transaction_purchase["ppn"] ?? $ppn, 'ppn_percent', $transaction_purchase["ppn_percent"] ?? '%', 'ppn_price', $transaction_purchase["ppn_price"] ?? '', 'onkeypress="return false;"', 'disabled', 'onkeypress="return false;"', 'ppn', 'ppn_percent', 'ppn_price', $mode) !!}
...
@section('scripts')
<script>
    <?php echo autocomplete_render("transaction_purchase_item",["items.name|like"],"getItem", ['code','name','category_name'], ['code']) ?>

    function setSubtotalPerItem(rowid) {
        var rowData = $(<?= $grid_id ?>_element).jqGrid('getRowData', rowid);
        if (!isNaN(rowData.amount)) {
            rowData.subtotal = rowData.amount * rowData.buy_price
