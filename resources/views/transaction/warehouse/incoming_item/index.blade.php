                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('transaction_warehouse_incoming_item')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                            ...
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('transaction_warehouse_incoming_item')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
        ...
        $('#myTable').DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    d.route = "{{ $menu_route }}";
                    d.filters = {
                        "key": "stock_transfers.is_approve_1",
                        "term": "equal",
                        "query": "true"
                    };
                }
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (row.is_approve_2 == 'Not Approved') {
                            return showButton + approveButton;
                        } else {
