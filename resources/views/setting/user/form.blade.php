                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    {!! renderBrowserInput('mb-3 row', 'col-md-4', 'col-8 col-md-5', 'browse_user_group_name', '', __('setting_user')['col_user_group'], $setting_user['user_group_name'] ?? '', $mode, 'required', $action_user_group, ["user_groups.name|like"], [], array('browse_user_group_id|id','browse_user_group_name|name'), ['name'], 'group-user', ['Name'], [['field'=>'name', 'name' => 'user_groups.name']], title_modal:'Get User Group', id_ajax: 'example') !!}
