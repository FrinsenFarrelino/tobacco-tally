                            ...
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('setting_group_user')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var setAccessButton = '<a href="' + row.setAccess + '" class="btn btn-info btn-sm rounded">Set Access Menu</a>';

                        return setAccessButton;
                    }
                },
                {
                    data: 'is_active',
