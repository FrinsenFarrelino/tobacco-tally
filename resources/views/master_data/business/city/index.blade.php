                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('master_data_business_city')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>{{ __('master_data_business_city')['col_code'] }}</th>
                                        <th>{{ __('master_data_business_city')['col_name'] }}</th>
                                        <th>{{ __('master_data_business_city')['col_province'] }}</th>
                                        <th>{{ __('master_data_business_city')['col_is_active'] }}</th>
                                        <th>{{ __('master_data_business_city')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
<script>
    $(document).ready(function() {
        $('#myTable').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('ajax-data-table', ['action' => 'getCity']) }}",
                type: "GET",
                data: function(d) {
                    d.route = "city"; // Add extra parameters here
                }
            },
            columns: [{
                    data: null,
