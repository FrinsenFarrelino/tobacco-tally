                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    {!! renderBrowserInput('mb-3 row', 'col-md-4', 'col-8 col-md-5', 'browse_province_name', '', __('master_data_business_city')['col_province'], $master_data_business_city['province_name'] ?? '', $mode, 'required', $action_province, ["provinces.code|like","provinces.name|like"], [], array('browse_province_id|id','browse_province_name|name'), ['code','name'], 'province', ['Code','Name'], [['field'=>'code', 'name' => 'provinces.code'], ['field'=>'name', 'name' => 'provinces.name']], title_modal:'Get Province', id_ajax: 'example') !!}
                                    ...
                                    {!! renderTextArea('mb-3 row', 'col-md-4 col-form-label', 'col-md-8', 'remark', __('master_data_business_city')['col_remark'], 5, $master_data_business_city["remark"] ?? '', $mode, '') !!}
