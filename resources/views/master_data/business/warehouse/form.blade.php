                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    {!! renderBrowserInput('mb-3 row', 'col-md-4', 'col-8 col-md-5', 'browse_branch_name', '', __('master_data_business_warehouse')['col_branch'], $master_data_business_warehouse['branch_name'] ?? '', $mode, 'required', $action_branch, ["branches.code|like","branches.name|like"], [], array('browse_branch_id|id','browse_branch_name|name'), ['code','name'], '', ['Code','Name'], [['field'=>'code', 'name' => 'branches.code'], ['field'=>'name', 'name' => 'branches.name']], title_modal:'Get Branch', id_ajax: 'example') !!}
