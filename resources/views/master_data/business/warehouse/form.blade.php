                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    {!! renderInput('mb-3 row', 'col-md-4 col-form-label', 'col-md-8', 'number', 'capacity', __('master_data_business_warehouse')['col_capacity'], $master_data_business_warehouse['capacity'] ?? '', $mode, 'required') !!}
