                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    {!! renderBrowserInput('mb-3 row', 'col-md-4', 'col-8 col-md-5', 'browse_item_name', '', __('master_data_business_warehouse')['col_item'], $master_data_business_warehouse['item_name'] ?? '', $mode, 'required', $action_item, ["items.code|like","items.name|like"], [], array('browse_item_id|id','browse_item_name|name'), ['code','name'], 'item', ['Code','Name'], [['field'=>'code', 'name' => 'items.code'], ['field'=>'name', 'name' => 'items.name']], title_modal:'Get Item', id_ajax: 'example') !!}
