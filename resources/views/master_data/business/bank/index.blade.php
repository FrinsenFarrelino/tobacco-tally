                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('master_data_business_bank')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>{{ __('master_data_business_bank')['col_code'] }}</th>
                                        <th>{{ __('master_data_business_bank')['col_name'] }}</th>
                                        <th>{{ __('master_data_business_bank')['col_is_active'] }}</th>
                                        <th>{{ __('master_data_business_bank')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
