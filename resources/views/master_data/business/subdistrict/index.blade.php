                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('master_data_business_subdistrict')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>{{ __('master_data_business_subdistrict')['col_code'] }}</th>
                                        <th>{{ __('master_data_business_subdistrict')['col_name'] }}</th>
                                        <th>{{ __('master_data_business_subdistrict')['col_city'] }}</th>
                                        <th>{{ __('master_data_business_subdistrict')['col_province'] }}</th>
                                        <th>{{ __('master_data_business_subdistrict')['col_is_active'] }}</th>
                                        <th>{{ __('master_data_business_subdistrict')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
<script>
    $(document).ready(function() {
        $('#myTable').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('ajax-data-table', ['action' => 'getSubdistrict']) }}",
                type: "GET",
                data: function(d) {
                    d.route = "subdistrict"; // Add extra parameters here
                }
            },
            columns: [{
                    data: null,
