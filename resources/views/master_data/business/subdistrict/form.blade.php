                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    {!! renderTextArea('mb-3 row', 'col-md-4 col-form-label', 'col-md-8', 'remark', __('master_data_business_subdistrict')['col_remark'], 5, $master_data_business_subdistrict["remark"] ?? '', $mode, 'required') !!}
