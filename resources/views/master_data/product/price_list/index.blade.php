                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('master_data_product_price_list')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>{{ __('master_data_product_price_list')['col_code'] }}</th>
                                        <th>{{ __('master_data_product_price_list')['col_name'] }}</th>
                                        <th>{{ __('master_data_product_price_list')['col_item'] }}</th>
                                        <th>{{ __('master_data_product_price_list')['col_selling_price'] }}</th>
                                        <th>{{ __('master_data_product_price_list')['col_is_active'] }}</th>
                                        <th>{{ __('master_data_product_price_list')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
