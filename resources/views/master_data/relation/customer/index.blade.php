                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('master_data_relation_customer')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>{{ __('master_data_relation_customer')['col_code'] }}</th>
                                        <th>{{ __('master_data_relation_customer')['col_title'] }}</th>
                                        <th>{{ __('master_data_relation_customer')['col_name'] }}</th>
                                        <th>{{ __('master_data_relation_customer')['col_address'] }}</th>
                                        <th>{{ __('master_data_relation_customer')['col_is_active'] }}</th>
                                        <th>{{ __('master_data_relation_customer')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
