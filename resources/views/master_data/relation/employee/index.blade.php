                ...
                <div class="card">
                    <div class="d-flex justify-content-between">
                        <div class="card-header">
                            <h4>{{ __('master_data_relation_employee')['list'] }} {{ $title }} - {{ $subtitle }}</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped" id="myTable">
                                <thead>
                                    <tr>
                                        <th>{{ __('master_data_relation_employee')['col_code'] }}</th>
                                        <th>{{ __('master_data_relation_employee')['col_name'] }}</th>
                                        <th>{{ __('master_data_relation_employee')['col_position'] }}</th>
                                        <th>{{ __('master_data_relation_employee')['col_division'] }}</th>
                                        <th>{{ __('master_data_relation_employee')['col_is_active'] }}</th>
                                        <th>{{ __('master_data_relation_employee')['col_action'] }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
